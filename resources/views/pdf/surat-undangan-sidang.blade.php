...
<body>
    ...
    <table class="meta-table" style="margin-bottom: 10px;">
        <tr>
            ...
            <td style="width: 2%;">:</td>
            <td>
                <strong>Yth. Bapak / Ibu Tim Penguji</strong>
                <table class="tim-table" style="margin-top: 3px; margin-left: 10px;">
                    @foreach($timPenguji as $index => $dosen)
                        <tr>
                            <td style="width: 22px;">{{ $index + 1 }}.</td>
                            <td style="width: 55%;">{{ $dosen['nama'] }}</td>
                            <td>({{ $dosen['peran'] }})</td>
                        </tr>
                    @endforeach
                </table>
    ...
    <div style="margin-bottom: 8px; text-align: justify;">
        Sehubungan dengan akan dilaksanakan Sidang Skripsi mahasiswa atas nama :
    </div>
    ...
    <div style="margin-bottom: 6px; text-align: justify;">
        Untuk itu kami mengharapkan kesediaan Bapak/Ibu menghadiri Sidang Skripsi mahasiswa tersebut sebagai Tim Penguji.
    </div>
